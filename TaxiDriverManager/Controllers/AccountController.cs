...
using TaxiDriverManager.Models.AccountViewModels;
        ...
        public async Task<IActionResult> Token(OpenIdConnectRequest request)
        {
            if (request.IsPasswordGrantType())
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    var roleClaim = await _userManager.GetRolesAsync(user);
                    var role = roleClaim[0].ToString();
                    identity.AddClaim(
                        OpenIdConnectConstants.Claims.Role, role,
                    ...
                    return/*  SignIn(ticket.Principal,ticket.Properties,ticket.AuthenticationScheme);*/ SignIn(principal, OpenIdConnectServerDefaults.AuthenticationScheme);
                }
                else
                {
